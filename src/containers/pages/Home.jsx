...
function Home({ categories, get_categories, get_blog_list, get_blog_list_page, blog_list }) {
  useEffect(() => {
  ...
  return (
    <FullWidthLayout>
      ...
      <BlogCategories />
      <BlogListSearch get_blog_list_page={get_blog_list_page} blog_list={blog_list} />
    </FullWidthLayout>
  );
}
