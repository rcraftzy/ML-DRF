            ...
            <div className="relative grid gap-8 bg-white dark:bg-dark-main p-7">
              ...
              >
                <div className="flex h-8 w-8 shrink-0 items-center justify-center text-white dark:text-dark-txt sm:h-12 sm:w-12">
                  <img
                    src="https://images.unsplash.com/photo-1550525811-e5869dd03032?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" // src={my_user && my_user.picture}
                  />
                </div>
                <div className="ml-4">
                ...
                <div className="flex md:absolute md:left-0 md:inset-y-0 lg:static xl:col-span-2">
                  <div className="flex-shrink-0 flex items-center">
                    <NavLink to="/">
                      ...
                      {/* White Image */}
                      <img
                        src="https://www.svgrepo.com/show/246615/artificial-intelligence-brain.svg"
                        width={45}
                        height={35}
                        layout="fixed"
                        alt=""
